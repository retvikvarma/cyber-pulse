    ...
    <div className="container mx-auto px-4 py-12">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-12">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 cyber-heading">Features Used</h2>
            <p className="text-gray-300 mb-6">
              The model uses 10 selected features from network packet data for classification:
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
              {[
                'IP_IHL', 'IP_TTL', 'IP_Len', 'IP_Frag', 'Proto',
                'Src_Port', 'Dst_Port', 'Window', 'Flags', 'Pkt_Len'
              ].map((feature) => (
                <div key={feature} className="bg-cyberpulse-darker rounded-lg p-3 text-center border border-cyberpulse-purple/20">
