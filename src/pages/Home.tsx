        ...
        <div className="container mx-auto flex flex-col md:flex-row items-center">
          ...
          <div className="md:w-1/2 mt-10 md:mt-0">
            <div className="relative">
              ...
              <div className="relative bg-cyberpulse-darker p-6 rounded-lg border border-cyberpulse-purple/30">
                <img 
                  src="/lovable-uploads/57a7f4ed-a8e2-4409-aead-06ef7762c4d3.png" 
